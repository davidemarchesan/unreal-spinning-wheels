#include "RaceMenuPopup.h"

#include "SpinningWheels/HUDs/UI/Slate/Styles/MainStyle.h"
#include "SpinningWheels/HUDs/UI/Slate/Widgets/MenuItemWidget.h"

void SRaceMenuPopup::Construct(const FArguments& InArgs)
{
			...
			[
				...
				[
					...
					[
						...
						.OnClicked(this, &SRaceMenuPopup::ExecuteOnBack)
					]
...
FReply SRaceMenuPopup::ExecuteOnBack()
{
	if (OnBack.IsBound())
	{
